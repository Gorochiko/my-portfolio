...
import KoreanFlutter2 from "../assets/korean-flutter-2.png"
import KoreanFlutter from "../assets/korean-flutter.png"
export const projectData = {
    ...
    "mobile-projects": {
        ...
        description: "Discover my portfolio of mobile development projects that highlight my skills in creating seamless and engaging mobile experiences. From intuitive user interfaces to robust backend integrations, each project showcases my ability to deliver high-quality mobile applications.",
        heroGradient: "from-green-400 via-blue-500 to-purple-600",
        sections: [
            {
                title: "KOREAN LEARNING APP",
                subtitle: "App for learning Korean language",
                content: "A mobile application designed to support Korean language learners by providing vocabulary, grammar, and pronunciation practice through a user-friendly interface.",
                details: "Design and build the entire user interface using Flutter. Work with API to display lesson data. Apply Bloc to e ectively manage the application state. Coordinate with the backend and designer to ensure a smooth and intuitive user experience. Added multi- language support using Flu er i18n. Implemented user authentication(login, registration) using JWT, including token handling and secure routing.",
                tech: ["Flutter", "Dart", "Bloc Pattern", "i10n"],
            liveUrl: "https://play.google.com/store/apps/details?id=com.cinevie",
            githubUrl: "https://github.com/nttaif/hypee_topiks_application",
            image_url_screen: KoreanFlutter2,
            image_url_mobile: KoreanFlutter,
